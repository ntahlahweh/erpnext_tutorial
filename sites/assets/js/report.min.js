var Rollup = (function (exports) {
		...
		Sortable.prototype = /** @lends Sortable.prototype */ {
			...
			_computeIsAligned: function(evt) {
				...
				for (var i = 0; i < children.length; i++) {
					...
					if (_closest(children[i], this$1.options.draggable, this$1.el, false) && children[i] !== target) {
						children[i].sortableMouseAligned = _isClientInRowColumn(evt.clientX, evt.clientY, children[i], this$1._getDirection(evt, null), this$1.options);
					}
				}
					...
					if (parent) {
						do {
							if (parent[expando]) {
								...
								if (inserted && !this$1.options.dragoverBubble) {
									break;
								}
							}
			...
			toArray: function () {
				...
				for (; i < n; i++) {
					el = children[i];
					if (_closest(el, options.draggable, this$1.el, false)) {
	...
	frappe.views.QueryReport = class QueryReport extends frappe.views.BaseList {
		...
		get_possible_chart_options() {
			...
			function make_chart_options(ref) {
			...
			function preview_chart() {
				...
				var options = make_chart_options(values);
			...
			var dialog = new frappe.ui.Dialog({
				...
				primary_action: function (values) {
					...
					options.title = __(((this$1.report_name) + ": " + (numeric_fields.filter(function (field) { return field.fieldname == values.y_field; })[0].label) + " vs " + (non_numeric_fields.filter(function (field) { return field.fieldname == values.x_field; })[0].label)));
