    	...
    	make() {
    		...
    		this.comment_area = frappe.ui.form.make_control({
    			...
    			on_submit: function (val) {
    				strip_html(val) && this$1.insert_comment("Comment", val, this$1.comment_area.button);
    			}
    		});
